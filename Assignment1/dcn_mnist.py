...
Original file is located at
    https://colab.research.google.com/drive/10B1YKVfcAZIpUjH4Fi9bJTkv5HNdkKyp
"""
...
# Insert the input_data.py directory

# Import local input_data.py file if importing from google drive is not working
# from google.colab import files
# src = list(files.upload().values())[0]
# open('input_data.py','wb').write(src)
# import input_data

# Import files from cloud service
import sys
...
def weight_variable(shape):
    ...
    # Initiate weight with Xavier Initializer
    initial = tf.compat.v1.keras.initializers.glorot_uniform()
